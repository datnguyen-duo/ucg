(function ($) {
  $(document).ready(function () {
    ...
    setTimeout(function () {
      ...
      $(".select2-selection--multiple").each(function (index) {
        $(this).append(
          '<span class="select2-selection__arrow" role="presentation"><b role="presentation"></b><img src="images/select_arrow.svg"></span>'
        );
      });
    }, 1000);
  ...
  function checkSection() {
    ...
    $(".single_section").each(function (index, el) {
      if (
        $(this).offset().top < bodyScroll + winHalf &&
        $(this).offset().top > bodyScroll
      ) {
        var id = $(this).attr("id");
